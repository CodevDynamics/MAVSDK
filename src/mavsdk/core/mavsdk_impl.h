...
private:
    ...
    Mavsdk::ConnectionHandle add_connection(std::unique_ptr<Connection>&& connection, UdpConnection* udp_connection_ptr = nullptr);
    ...
    struct ConnectionEntry {
        ...
        Handle<> handle;
        UdpConnection* udp_connection_ptr{nullptr};
    };
