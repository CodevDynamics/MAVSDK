...
void TelemetryImpl::process_sys_status(const mavlink_message_t& message)
{
    ...
    if (((sys_status.onboard_control_sensors_enabled & MAV_SYS_STATUS_SENSOR_3D_GYRO) && !(sys_status.onboard_control_sensors_health & MAV_SYS_STATUS_SENSOR_3D_GYRO)) ||
        ((sys_status.onboard_control_sensors_enabled & MAV_SYS_STATUS_SENSOR_3D_GYRO2) && !(sys_status.onboard_control_sensors_health & MAV_SYS_STATUS_SENSOR_3D_GYRO2))) {
        set_health_gyrometer_calibration(false);
    } else {
    ...
    if (sys_status.onboard_control_sensors_enabled & MAV_SYS_STATUS_SENSOR_3D_MAG) {
